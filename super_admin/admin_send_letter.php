...
// Clear the messages after capturing
                        ...
                        <div class="">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12">
                                    <div class="x_panel">
                                        <div class="x_title">
                                            <h2><small>Create a Letter</small></h2>
...
<?php endif; ?> -->
 ...
 <div class="x_panel">
                                <div class="x_title">
                                    <h2><small>Create Meeting</small></h2>
                                    <ul class="nav navbar-right panel_toolbox">
                                        <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a></li>
                                    </ul>
                                    <div class="clearfix"></div>
                                ...
                                <div class="x_content">
                <form id="create-meeting-form" action="create_meeting.php" method="POST" class="form-horizontal form-label-left">
                                        <div class="item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3 label-align" for="meeting_name">Meeting Name <span class="required">*</span></label>
                                            <div class="col-md-6 col-sm-6">
                                                <input type="text" id="meeting_name" name="meeting_name" required="required" class="form-control">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                        ...
                                        <div class="item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3 label-align" for="meeting_date">Meeting Date and Time <span class="required">*</span></label>
                                            <div class="col-md-6 col-sm-6">
                                                <input type="datetime-local" id="meeting_date" name="meeting_date" required="required" class="form-control">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3 label-align" for="meeting_description">Description</label>
                                            <div class="col-md-6 col-sm-6">
                                                <textarea id="meeting_description" name="meeting_description" class="form-control"></textarea>
                                            </div>
                                        </div>
                                        <div class="ln_solid"></div>
                                        <div class="item form-group">
