...
<div class="row no-print">
        ...
        <button class="btn btn-default" onclick="printTable();"><i class="fa fa-print"></i> Print Table</button>
            ...
            <div class="page-title">
              <div class="title_left">
                <h3>Pending Resolutions Lists</h3>
              </div>
    ...
    <tbody>
        ...
        <?php else: ?>
            <tr>
                <td colspan="6" class="text-center">No pending resolutions found.</td>
            </tr>
        <?php endif; ?>
    </tbody>
</table>
    ...
    function printTable() {
        ...
        printWindow.document.write('<p>Below is the list of your submitted resolutions:</p>');
