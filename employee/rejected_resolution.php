...
try {
    // Query to fetch Rejected resolutions authored by the logged-in user
    $query = "
        SELECT 
            d.document_id, 
        ...
        LEFT JOIN (
            ...
            WHERE status = 'Rejected' -- Only fetch Rejected statuses
...
.profile_info h2 {
  ...
  <body class="nav-md">
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Rejected Resolution Lists</h3>
              </div>
    ...
    <tbody>
        ...
        <?php else: ?>
            <tr>
                <td colspan="9" class="text-center">No Rejected Resolutions Found.</td>
            </tr>
        <?php endif; ?>
    </tbody>
</table>
