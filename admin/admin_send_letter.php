...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['submit_session'])) {
    $name = $_POST['name'];
    $subject = $_POST['subject'];
    $event_type = $_POST['event_type'];
    $host_id = $user_id; // Admin creating the session
    ...
    $insert_sql = "INSERT INTO sessions (name, subject, event_type, host_id, start_time, recurrence, date, description, created_by) 
                   VALUES (:name, :subject, :event_type, :host_id, :start_time, :recurrence, :date, :description, :created_by)";
    ...
    if ($stmt->execute()) {
        ...
        $error_message = "Failed to add the session.";
    }
}
...
<?php endif; ?> -->
                                            ...
                                            <form id="request-letter-form" action="send_admin.php" method="POST" enctype="multipart/form-data" class="form-horizontal form-label-left">
                        ...
                        <div class="ln_solid"></div>
                          <!-- Form to Add Session -->
                          <h2><small>Add Session</small></h2>
                      <form id="add-session-form" action="" method="POST" class="form-horizontal form-label-left">
                                                <div class="item form-group">
                                                    <label class="col-form-label col-md-3 col-sm-3 label-align" for="name">Session Name <span class="required">*</span></label>
                                                    <div class="col-md-6 col-sm-6">
                                                ...
                                                <div class="item form-group">
                                                    <label class="col-form-label col-md-3 col-sm-3 label-align" for="event_type">Event Type <span class="required">*</span></label>
                                                    <div class="col-md-6 col-sm-6">
                                                ...
                                                <div class="item form-group">
                                                    <label class="col-form-label col-md-3 col-sm-3 label-align" for="start_time">Start Time <span class="required">*</span></label>
                                                    <div class="col-md-6 col-sm-6">
                                                        <input type="time" id="start_time" name="start_time" required="required" class="form-control">
                                                    </div>
                                                </div>

                                                <div class="item form-group">
                                                    <label class="col-form-label col-md-3 col-sm-3 label-align" for="recurrence">Recurrence <span class="required">*</span></label>
                                                    <div class="col-md-6 col-sm-6">
                                                ...
                                                <div class="item form-group">
                                                    <label class="col-form-label col-md-3 col-sm-3 label-align" for="date">Specific Date (for Meetings)</label>
                                                    <div class="col-md-6 col-sm-6">
                                                ...
                                                <div class="item form-group">
                                                    <div class="col-md-6 col-sm-6 offset-md-3">
                                                        ...
                                                        <button type="submit" name="submit_session" class="btn btn-success">Add Session</button>
                    </div>
