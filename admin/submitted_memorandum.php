...
// Handle archiving of submitted Memorandum via POST request
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!empty($documentIds)) {
        try {
            ...
            echo "Submitted Memorandum archived successfully!";
        } catch (PDOException $e) {
            echo "Error archiving Memorandum: " . $e->getMessage();
        }
    } else {
...
document.getElementById('archiveButton').addEventListener('click', function() {
    ...
    if (selectedIds.length > 0) {
        ...
        xhr.open('POST', 'submitted_memorandum.php', true);
