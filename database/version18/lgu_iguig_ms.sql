...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 27, 2025 at 03:20 AM
...
CREATE TABLE `sessions` (
  ...
  `facilitator_id` int(11) DEFAULT NULL COMMENT 'Facilitator for sessions (if applicable)',
  `materials_path` varchar(255) DEFAULT NULL COMMENT 'Path to training or session materials',
...
INSERT INTO `sessions` (`session_id`, `name`, `subject`, `event_type`, `host_id`, `facilitator_id`, `materials_path`, `start_time`, `recurrence`, `date`, `description`, `created_by`, `created_at`) VALUES
(1, 'dsa', 'dsa', 'Meeting', 1, NULL, NULL, '13:00:00', 'One-time', '2025-01-26 12:50:00', 'dsa', 1, '2025-01-26 04:51:21');
...
(1, 20, '2025-01-22 06:49:05', '2025-01-22 06:49:01', '2025-01-22 06:49:17', NULL, '2025-01-22 12:41:48', '2025-01-22 13:49:34'),
...
ALTER TABLE `sessions`
  ...
  ADD CONSTRAINT `sessions_ibfk_2` FOREIGN KEY (`facilitator_id`) REFERENCES `users` (`user_id`) ON DELETE SET NULL;
